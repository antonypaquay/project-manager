    ...
    class ProjectInput extends App.Component {
        ...
        submitHandler(e) {
            ...
            if (Array.isArray(userInput)) {
                ...
                App.projectState.addProject(title, descrpition, people);
                this.clearInputs();
            }
        }
    }
...
(function (App) {
    class ProjectList extends App.Component {
        ...
        dropHandler(event) {
            ...
            App.projectState.moveProject(prjId, this.type === 'active' ? App.ProjectStatus.Active : App.ProjectStatus.Done);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector('ul');
        ...
        configure() {
            ...
            App.projectState.addListener((projects) => {
                const revelantProjects = projects.filter(prj => {
                    ...
                    return prj.status === App.ProjectStatus.Done;
                });
        ...
        renderProjects() {
            ...
            for (const ptjItem of this.assignedProjects) {
                new App.ProjectItem(this.element.querySelector('ul').id, ptjItem);
            }
        }
    }
    __decorate([
